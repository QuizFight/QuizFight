...
data class GameData(val id: Int, val gameName:String, val maxPlayer: Int, val questions: MutableList<Question>) : Serializable //TODO: Add ip for GameServer
data class GameServerData(val ip: String, val port: Int, val games : List<GameData>) : Serializable
